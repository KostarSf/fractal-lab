...
`;function Hl(e){return e.parameters.map(e=>`uniform ${e.type===`complex`?`vec2`:`float`} ${e.uniform};`).join(`
`)}function Ul(e){return`#version 300 es
precision highp float;
...
`}var Wl=[`u_resolution`,`u_center`,`u_scale`,`u_maxIterations`,`u_palette`,`u_colorDensity`,`u_colorOffset`,`u_smoothColors`];function Gl(e,t,n){let r=e.createShader(t);if(!r)throw Error(`WebGL не смог создать шейдер.`);if(e.shaderSource(r,n),e.compileShader(r),!e.getShaderParameter(r,e.COMPILE_STATUS)){let t=e.getShaderInfoLog(r)??`Неизвестная ошибка компиляции.`;throw e.deleteShader(r),Error(`Ошибка компиляции GLSL:\n${t}`)}return r}function Kl(e,t,n){let r=Gl(e,e.VERTEX_SHADER,t),i=Gl(e,e.FRAGMENT_SHADER,n),a=e.createProgram();if(!a)throw e.deleteShader(r),e.deleteShader(i),Error(`WebGL не смог создать программу.`);if(e.attachShader(a,r),e.attachShader(a,i),e.linkProgram(a),e.deleteShader(r),e.deleteShader(i),!e.getProgramParameter(a,e.LINK_STATUS)){let t=e.getProgramInfoLog(a)??`Неизвестная ошибка линковки.`;throw e.deleteProgram(a),Error(`Ошибка линковки WebGL-программы:\n${t}`)}return a}function ql(e,t,n){let r=e.getUniformLocation(t,n);if(r===null)throw Error(`Uniform ${n} отсутствует в шейдере.`);return r}var Jl=class{#e;#t;#n;#r;#i;#a=new Map;#o=new Map;constructor(e){let t=e.getContext(`webgl2`,{alpha:!1,antialias:!1,depth:!1,powerPreference:`high-performance`,preserveDrawingBuffer:!1,stencil:!1});if(!t)throw Error(`WebGL2 недоступен. Проверьте поддержку браузера и аппаратное ускорение.`);let n=t.createVertexArray();if(!n)throw Error(`WebGL не смог создать vertex array.`);this.#e=e,this.#t=t,this.#n=n,t.bindVertexArray(n)}setFormula(e){let t=Kl(this.#t,Vl,Ul(e)),n=new Map,r=new Map;for(let e of Wl)n.set(e,ql(this.#t,t,e));for(let n of e.parameters)r.set(n.key,ql(this.#t,t,n.uniform));this.#i&&this.#t.deleteProgram(this.#i),this.#r=e,this.#i=t,this.#a=n,this.#o=r}resize(e){let t=Math.min(window.devicePixelRatio||1,2)*e,n=Math.max(1,Math.round(this.#e.clientWidth*t)),r=Math.max(1,Math.round(this.#e.clientHeight*t));return this.#e.width===n&&this.#e.height===r?!1:(this.#e.width=n,this.#e.height=r,!0)}render(e){if(!this.#i||!this.#r)throw Error(`Формула не выбрана.`);let t=this.#t;t.disable(t.BLEND),t.viewport(0,0,this.#e.width,this.#e.height),t.useProgram(this.#i),t.bindVertexArray(this.#n),t.uniform2f(this.#a.get(`u_resolution`),this.#e.width,this.#e.height),t.uniform2f(this.#a.get(`u_center`),e.center[0],e.center[1]),t.uniform1f(this.#a.get(`u_scale`),e.scale),t.uniform1i(this.#a.get(`u_maxIterations`),e.maxIterations),t.uniform1i(this.#a.get(`u_palette`),e.palette),t.uniform1f(this.#a.get(`u_colorDensity`),e.colorDensity),t.uniform1f(this.#a.get(`u_colorOffset`),e.colorOffset),t.uniform1i(this.#a.get(`u_smoothColors`),+!!e.smoothColors);for(let n of this.#r.parameters){let r=this.#o.get(n.key),i=e.parameters[n.key];!r||i===void 0||(n.type===`complex`&&Array.isArray(i)?t.uniform2f(r,i[0],i[1]):n.type===`number`&&typeof i==`number`&&t.uniform1f(r,i))}t.drawArrays(t.TRIANGLES,0,3)}dispose(){this.#i&&=(this.#t.deleteProgram(this.#i),void 0),this.#t.deleteVertexArray(this.#n)}},Yl=2048;function Xl(e){return e.parameters.map(e=>`uniform ${e.type===`complex`?`vec2`:`float`} ${e.uniform};`).join(`
...
`}function Ql(e){return e.basinBackend===`newton-cubic`?`
...
`:`
    colorIteration += hasPreviousMetric
      ...
      : 1.0;
`}function $l(e){return`#version 300 es
precision highp float;
...
`}var eu=[`u_resolution`,`u_center`,`u_scale`,`u_maxIterations`,`u_palette`,`u_colorDensity`,`u_colorOffset`,`u_smoothColors`],tu=class{#e;#t;#n;#r;#i;#a=new Map;#o=new Map;constructor(e){let t=e.getContext(`webgl2`);if(!t)throw Error(`WebGL2 недоступен для root-basin renderer.`);let n=t.createVertexArray();if(!n)throw Error(`WebGL не смог создать root-basin vertex array.`);this.#e=e,this.#t=t,this.#n=n}setFormula(e){let t=Kl(this.#t,Vl,$l(e)),n=new Map,r=new Map;for(let e of eu)n.set(e,ql(this.#t,t,e));for(let n of e.parameters)r.set(n.key,ql(this.#t,t,n.uniform));this.#i&&this.#t.deleteProgram(this.#i),this.#r=e,this.#i=t,this.#a=n,this.#o=r}resize(e){let t=Math.min(window.devicePixelRatio||1,2)*e,n=Math.max(1,Math.round(this.#e.clientWidth*t)),r=Math.max(1,Math.round(this.#e.clientHeight*t));return this.#e.width===n&&this.#e.height===r?!1:(this.#e.width=n,this.#e.height=r,!0)}render(e){if(!this.#r||!this.#i)throw Error(`Root-basin формула не выбрана.`);let t=this.#t;t.disable(t.BLEND),t.viewport(0,0,this.#e.width,this.#e.height),t.useProgram(this.#i),t.bindVertexArray(this.#n),t.uniform2f(this.#a.get(`u_resolution`),this.#e.width,this.#e.height),t.uniform2f(this.#a.get(`u_center`),e.center[0],e.center[1]),t.uniform1f(this.#a.get(`u_scale`),e.scale),t.uniform1i(this.#a.get(`u_maxIterations`),e.maxIterations),t.uniform1i(this.#a.get(`u_palette`),e.palette),t.uniform1f(this.#a.get(`u_colorDensity`),e.colorDensity),t.uniform1f(this.#a.get(`u_colorOffset`),e.colorOffset),t.uniform1i(this.#a.get(`u_smoothColors`),+!!e.smoothColors),this.#s(e.parameters),t.drawArrays(t.TRIANGLES,0,3)}dispose(){this.#i&&=(this.#t.deleteProgram(this.#i),void 0),this.#t.deleteVertexArray(this.#n)}#s(e){for(let t of this.#r.parameters){let n=this.#o.get(t.key),r=e[t.key];!n||r===void 0||(t.type===`complex`&&Array.isArray(r)?this.#t.uniform2f(n,r[0],r[1]):t.type===`number`&&typeof r==`number`&&this.#t.uniform1f(n,r))}}},nu=`#version 300 es
precision highp float;
...
`,iu=[`u_resolution`,`u_center`,`u_scale`,`u_pointSize`,`u_pointCount`,`u_palette`,`u_colorOffset`,`u_exposure`],au=class{#e;#t;#n;#r;#i;#a=new Map;#o;#s=0;constructor(e){let t=e.getContext(`webgl2`);if(!t)throw Error(`WebGL2 недоступен для Clifford renderer.`);let n=t.createVertexArray(),r=t.createBuffer();if(!n||!r)throw Error(`WebGL не смог создать ресурсы Clifford renderer.`);this.#e=e,this.#t=t,this.#n=Kl(t,nu,ru),this.#r=n,this.#i=r,t.bindVertexArray(n),t.bindBuffer(t.ARRAY_BUFFER,r),t.enableVertexAttribArray(0),t.vertexAttribPointer(0,2,t.FLOAT,!1,0,0);for(let e of iu)this.#a.set(e,ql(t,this.#n,e));let i=t.getParameter(t.ALIASED_POINT_SIZE_RANGE);this.#o=i[1]??1}setPoints(e){let t=this.#t;t.bindBuffer(t.ARRAY_BUFFER,this.#i),t.bufferData(t.ARRAY_BUFFER,e,t.STATIC_DRAW),this.#s=Math.trunc(e.length/2)}clearPoints(){this.#s=0}resize(e){let t=Math.min(window.devicePixelRatio||1,2)*e,n=Math.max(1,Math.round(this.#e.clientWidth*t)),r=Math.max(1,Math.round(this.#e.clientHeight*t));return this.#e.width===n&&this.#e.height===r?!1:(this.#e.width=n,this.#e.height=r,!0)}render(e){let t=this.#t;if(t.viewport(0,0,this.#e.width,this.#e.height),t.clearColor(.004,.006,.012,1),t.clear(t.COLOR_BUFFER_BIT),this.#s===0)return;let n=this.#e.clientWidth>0?this.#e.width/this.#e.clientWidth:1,r=Math.min(this.#o,Math.max(1,e.pointSize*n)),i=Math.max(1,Math.min(this.#s,Math.trunc(this.#s*Math.max(.05,Math.min(1,e.pointFraction)))));t.useProgram(this.#n),t.bindVertexArray(this.#r),t.enable(t.BLEND),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.SRC_ALPHA,t.ONE),t.uniform2f(this.#a.get(`u_resolution`),this.#e.width,this.#e.height),t.uniform2f(this.#a.get(`u_center`),e.center[0],e.center[1]),t.uniform1f(this.#a.get(`u_scale`),e.scale),t.uniform1f(this.#a.get(`u_pointSize`),r),t.uniform1i(this.#a.get(`u_pointCount`),i),t.uniform1i(this.#a.get(`u_palette`),e.palette),t.uniform1f(this.#a.get(`u_colorOffset`),e.colorOffset),t.uniform1f(this.#a.get(`u_exposure`),Math.max(0,e.exposure)),t.drawArrays(t.POINTS,0,i),t.disable(t.BLEND)}dispose(){this.#t.deleteBuffer(this.#i),this.#t.deleteVertexArray(this.#r),this.#t.deleteProgram(this.#n)}};function ou(e){if(!Number.isFinite(e.contractionRatio)||e.contractionRatio<=0||e.contractionRatio>=1)throw Error(`Коэффициент сокращения IFS должен быть между 0 и 1.`);if(!Number.isInteger(e.recommendedMaxDepth)||e.recommendedMaxDepth<1||e.recommendedMaxDepth>32)throw Error(`Глубина IFS должна быть от 1 до 32.`);if(!Number.isInteger(e.defaultDepth)||e.defaultDepth<1||e.defaultDepth>e.recommendedMaxDepth)throw Error(`Начальная глубина IFS выходит за рекомендуемый предел.`);if(e.transforms.length===0||e.transforms.some(e=>!uu(e)))throw Error(`IFS должен содержать конечные аффинные преобразования.`);if(e.backend===`grid`){let{columns:t,rows:n,mask:r}=e.grid,i=t*n;if(!Number.isInteger(t)||!Number.isInteger(n)||t<2||n<2||i>16||r.length!==i)throw Error(`Grid IFS поддерживает от 2 до 16 ячеек.`);if(r.filter(Boolean).length!==e.transforms.length)throw Error(`Число grid-преобразований не совпадает с маской IFS.`);if(e.baseArea.size.length!==2||e.baseArea.size.some(e=>!Number.isFinite(e)||e<=0))throw Error(`Базовый прямоугольник IFS должен иметь положительный размер.`);return}if(Math.abs(cu(e.baseArea.vertices))<2**-52)throw Error(`Базовый треугольник IFS не должен быть вырожденным.`)}function su(e,t,n){let r=Math.max(Number.MIN_VALUE,Math.abs(e)),i=Math.max(1,t),a=(n.backend===`grid`?Math.max(n.baseArea.size[0],n.baseArea.size[1]):lu(n.baseArea.vertices))*i/r,o=Math.ceil(Math.log(Math.max(1,a/1.35))/-Math.log(n.contractionRatio));return Math.max(1,Math.min(n.recommendedMaxDepth,o))}function cu(e){let[t,n,r]=e;return(n[0]-t[0])*(r[1]-t[1])-(r[0]-t[0])*(n[1]-t[1])}function lu(e){let t=e.map(e=>e[0]),n=e.map(e=>e[1]);return Math.max(Math.max(...t)-Math.min(...t),Math.max(...n)-Math.min(...n))}function uu(e){return[...e.matrix,...e.translate].every(Number.isFinite)}var du=`#version 300 es
precision highp float;
precision highp int;
...
`,fu=[`u_resolution`,`u_center`,`u_scale`,`u_ruleType`,`u_baseSize`,`u_triangleA`,`u_triangleB`,`u_triangleC`,`u_gridSize`,`u_gridMask[0]`,`u_contractionRatio`,`u_recursionDepth`,`u_autoDepth`,`u_palette`,`u_colorMode`,`u_colorOffset`],pu={solid:0,level:1,gradient:2},mu=class{#e;#t;#n;#r;#i=new Map;#a;constructor(e){let t=e.getContext(`webgl2`,{alpha:!1,antialias:!1,depth:!1,powerPreference:`high-performance`,preserveDrawingBuffer:!1,stencil:!1});if(!t)throw Error(`WebGL2 недоступен для geometric IFS renderer.`);let n=t.createVertexArray();if(!n)throw Error(`WebGL не смог создать vertex array для geometric IFS.`);this.#e=e,this.#t=t,this.#n=Kl(t,Vl,du),this.#r=n,t.bindVertexArray(n);for(let e of fu)this.#i.set(e,ql(t,this.#n,e))}setFormula(e){ou(e.geometricIfs),this.#a=e}resize(e){let t=Math.min(window.devicePixelRatio||1,2)*e,n=Math.max(1,Math.round(this.#e.clientWidth*t)),r=Math.max(1,Math.round(this.#e.clientHeight*t));return this.#e.width===n&&this.#e.height===r?!1:(this.#e.width=n,this.#e.height=r,!0)}render(e){let t=this.#a;if(!t)throw Error(`Geometric IFS-фрактал не выбран.`);let n=this.#t,r=t.geometricIfs,i=su(e.scale,this.#e.height,r),a=e.recursionDepthMode===`auto`?i:Math.max(1,Math.min(r.recommendedMaxDepth,Math.trunc(e.recursionDepth))),o=new Int32Array(16),s=[2,2],c=[3,3],l=[[-1,-1],[1,-1],[0,1]];if(r.backend===`grid`)s=r.baseArea.size,c=[r.grid.columns,r.grid.rows],r.grid.mask.forEach((e,t)=>{o[t]=+!!e});else{l=r.baseArea.vertices;let e=l.map(e=>e[0]),t=l.map(e=>e[1]);s=[Math.max(...e)-Math.min(...e),Math.max(...t)-Math.min(...t)]}n.disable(n.BLEND),n.viewport(0,0,this.#e.width,this.#e.height),n.useProgram(this.#n),n.bindVertexArray(this.#r),n.uniform2f(this.#i.get(`u_resolution`),this.#e.width,this.#e.height),n.uniform2f(this.#i.get(`u_center`),e.center[0],e.center[1]),n.uniform1f(this.#i.get(`u_scale`),e.scale),n.uniform1i(this.#i.get(`u_ruleType`),r.backend===`grid`?0:1),n.uniform2f(this.#i.get(`u_baseSize`),s[0],s[1]),n.uniform2f(this.#i.get(`u_triangleA`),l[0][0],l[0][1]),n.uniform2f(this.#i.get(`u_triangleB`),l[1][0],l[1][1]),n.uniform2f(this.#i.get(`u_triangleC`),l[2][0],l[2][1]),n.uniform2i(this.#i.get(`u_gridSize`),c[0],c[1]),n.uniform1iv(this.#i.get(`u_gridMask[0]`),o),n.uniform1f(this.#i.get(`u_contractionRatio`),r.contractionRatio),n.uniform1i(this.#i.get(`u_recursionDepth`),a),n.uniform1i(this.#i.get(`u_autoDepth`),+(e.recursionDepthMode===`auto`)),n.uniform1i(this.#i.get(`u_palette`),e.palette),n.uniform1i(this.#i.get(`u_colorMode`),pu[e.coloring]),n.uniform1f(this.#i.get(`u_colorOffset`),e.colorOffset),n.drawArrays(n.TRIANGLES,0,3)}dispose(){this.#t.deleteProgram(this.#n),this.#t.deleteVertexArray(this.#r)}},hu=`fractal-lab-previews-v5`,gu=`renderer-v5`,_u=480,vu=300,yu=new Map,bu=new Map,xu=Promise.resolve(),Su,Cu,wu,Tu,Eu,Du,Ou,ku,Au;function ju(e){let t=`${gu}-${e.id}`,n=yu.get(t);if(n)return Promise.resolve(n);let r=bu.get(t);if(r)return r;let i=Mu(e,t).catch(e=>{throw bu.delete(t),e});return bu.set(t,i),i}async function Mu(e,t){let n=await Wu(t),r=n??await Nu(()=>Fu(e));n||Gu(t,r);let i=URL.createObjectURL(r);return yu.set(t,i),i}function Nu(e){let t=xu.then(Pu).then(e);return xu=t.then(()=>void 0,()=>void 0),t}function Pu(){return new Promise(e=>{if(`requestIdleCallback`in window){window.requestIdleCallback(()=>e(),{timeout:250});return}setTimeout(e,16)})}async function Fu(e){let t={...Ps(e),...e.preview.parameters};if(e.renderer===`escape-time`){let{canvas:n,renderer:r}=Ru();return r.setFormula(e),r.render(Iu(e,t)),Uu(n)}if(e.renderer===`root-basin`){let{canvas:n,renderer:r}=zu();return r.setFormula(e),r.render(Iu(e,t)),Uu(n)}if(e.renderer===`geometric-ifs`){let{canvas:t,renderer:n}=Lu();return n.setFormula(e),n.render({center:e.preview.view.center,scale:e.preview.view.scale,recursionDepthMode:`manual`,recursionDepth:e.preview.recursionDepth??e.geometricIfs.defaultDepth,coloring:e.preview.geometricColoring??e.geometricIfs.defaultColoring,palette:e.preview.palette??0,colorOffset:e.preview.colorOffset??0}),Uu(t)}let{canvas:n,renderer:r,client:i}=Bu(),a=await i.request({a:Hu(t,`a`,-1.4),b:Hu(t,`b`,1.6),c:Hu(t,`c`,1),d:Hu(t,`d`,.7),burnIn:Hu(t,`burnIn`,100),pointCount:Hu(t,`pointCount`,18e4)});return r.setPoints(a.values),r.render({center:e.preview.view.center,scale:e.preview.view.scale,palette:e.preview.palette??0,colorOffset:e.preview.colorOffset??0,exposure:Hu(t,`exposure`,.11),pointSize:Hu(t,`pointSize`,1.25),pointFraction:1}),Uu(n)}function Iu(e,t){return{center:e.preview.view.center,scale:e.preview.view.scale,maxIterations:e.preview.iterations??e.suggestedIterations,palette:e.preview.palette??0,colorDensity:e.preview.colorDensity??.075,colorOffset:e.preview.colorOffset??0,smoothColors:!0,parameters:t}}function Lu(){return(!Eu||!Du)&&(Eu=Vu(),Du=new mu(Eu)),{canvas:Eu,renderer:Du}}function Ru(){return(!Su||!Cu)&&(Su=Vu(),Cu=new Jl(Su)),{canvas:Su,renderer:Cu}}function zu(){return(!wu||!Tu)&&(wu=Vu(),Tu=new tu(wu)),{canvas:wu,renderer:Tu}}function Bu(){return(!Ou||!ku||!Au)&&(Ou=Vu(),ku=new au(Ou),Au=new zl),{canvas:Ou,renderer:ku,client:Au}}function Vu(){let e=document.createElement(`canvas`);return e.width=_u,e.height=vu,e}function Hu(e,t,n){let r=e[t];return typeof r==`number`?r:n}function Uu(e){return new Promise((t,n)=>{e.toBlob(e=>{if(e){t(e);return}n(Error(`Браузер не смог создать изображение превью.`))},`image/webp`,.9)})}async function Wu(e){if(!(typeof caches>`u`))try{return(await(await caches.open(hu)).match(Ku(e)))?.blob()}catch{return}}async function Gu(e,t){if(!(typeof caches>`u`))try{await(await caches.open(hu)).put(Ku(e),new Response(t,{headers:{"Content-Type":t.type||`image/webp`}}))}catch{}}function Ku(e){return new URL(`/__fractal-previews__/${encodeURIComponent(e)}.webp`,window.location.href).href}var qu=[`data-status`],Ju=[`src`],Yu={key:1,class:`preview-error`},Xu={key:2,class:`preview-loader`},Zu=ir({__name:`FractalPreview`,props:{formula:{}},setup(e){let t=e,n=z(),r=z(``),i=z(`idle`),a,o=!1;yr(()=>{if(!n.value||!(`IntersectionObserver`in window)){s();return}a=new IntersectionObserver(e=>{e.some(e=>e.isIntersecting)&&(a?.disconnect(),a=void 0,s())},{rootMargin:`240px`}),a.observe(n.value)}),Sr(()=>{o=!0,a?.disconnect()});async function s(){if(i.value===`idle`){i.value=`loading`;try{let e=await ju(t.formula);o||(r.value=e,i.value=`ready`)}catch{o||(i.value=`error`)}}}return(e,t)=>(U(),W(`span`,{ref_key:`root`,ref:n,class:`fractal-preview`,"data-status":i.value,"aria-hidden":`true`},[r.value?(U(),W(`img`,{key:0,src:r.value,alt:``},null,8,Ju)):i.value===`error`?(U(),W(`span`,Yu,[...t[0]||=[G(`svg`,{viewBox:`0 0 24 24`},[G(`path`,{d:`M6.5 17.5 17.5 6.5M6.5 6.5l11 11`})],-1),sa(` Превью недоступно `,-1)]])):(U(),W(`span`,Xu,[...t[1]||=[G(`i`,null,null,-1),G(`i`,null,null,-1),G(`i`,null,null,-1)]]))],8,qu))}}),Qu=(e,t)=>{let n=e.__vccOpts||e;for(let[e,r]of t)n[e]=r;return n},$u=Qu(Zu,[[`__scopeId`,`data-v-ea460355`]]),ed={class:`picker-shell`},td={class:`navigator-tools`},nd={class:`formula-search`},rd={class:`category-filters`,"aria-label":`Категория формулы`},id=[`aria-pressed`,`onClick`],ad=[`aria-label`],od=[`data-renderer`,`aria-pressed`,`onClick`],sd={class:`card-visual`},cd={class:`card-index`},ld={key:0,class:`active-badge`},ud={class:`card-copy`},dd={class:`card-category`},fd={class:`card-description`},pd={key:0,class:`empty-results`},md=Qu(ir({__name:`FormulaPickerDialog`,emits:[`close`],setup(e,{emit:t}){let n=t,r=Ll(),{activeFormula:i}=Cs(r),a=z(),o=z(),s=z(``),c=z(`all`),l=Ia(()=>{let e=s.value.trim().toLocaleLowerCase(`ru`);return Ns.filter(t=>{let n=c.value===`all`||t.renderer===c.value,r=e.length===0||`${t.label} ${t.description}`.toLocaleLowerCase(`ru`).includes(e);return n&&r})});yr(async()=>{await vn(),a.value?.showModal(),o.value?.focus()});function u(){if(a.value?.open){a.value.close();return}n(`close`)}function d(e){r.selectFormula(e),u()}function f(e){e.target===a.value&&u()}function p(e){return e.renderer===`root-basin`?`Root basin`:e.renderer===`point-attractor`?`Attractor`:e.renderer===`geometric-ifs`?`Geometric IFS`:`Escape time`}return(e,t)=>(U(),Qi($n,{to:`body`},[G(`dialog`,{ref_key:`dialog`,ref:a,class:`formula-picker`,"aria-labelledby":`formula-picker-title`,onCancel:Ro(u,[`prevent`]),onClick:f,onClose:t[1]||=e=>n(`close`)},[G(`section`,ed,[G(`header`,{class:`picker-header`},[t[3]||=G(`div`,{class:`picker-heading`},[G(`h2`,{id:`formula-picker-title`},`Каталог фракталов`),G(`p`,null,`Формулы, геометрические IFS, бассейны и странные аттракторы`)],-1),G(`button`,{class:`picker-close`,type:`button`,"aria-label":`Закрыть`,onClick:u},[...t[2]||=[G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`m6.5 6.5 11 11m0-11-11 11`})],-1)]])]),G(`div`,td,[G(`label`,nd,[t[4]||=G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`circle`,{cx:`10.5`,cy:`10.5`,r:`5.75`}),G(`path`,{d:`m15 15 4 4`})],-1),jn(G(`input`,{ref_key:`searchInput`,ref:o,"onUpdate:modelValue":t[0]||=e=>s.value=e,type:`search`,placeholder:`Название или описание…`,"aria-label":`Поиск формулы`},null,512),[[ko,s.value]]),t[5]||=G(`kbd`,null,`Esc`,-1)]),G(`div`,rd,[(U(),W(Hi,null,kr([[`all`,`Все`],[`escape-time`,`Escape`],[`root-basin`,`Basins`],[`point-attractor`,`Attractors`],[`geometric-ifs`,`IFS`]],e=>G(`button`,{key:e[0],type:`button`,"aria-pressed":c.value===e[0],onClick:t=>c.value=e[0]},N(e[1]),9,id)),64))])]),G(`div`,{class:`formula-grid`,"aria-label":`Доступно формул: ${l.value.length}`},[(U(!0),W(Hi,null,kr(l.value,(e,n)=>(U(),W(`button`,{key:e.id,class:de([`formula-card`,{"is-active":e.id===B(i).id}]),"data-renderer":e.renderer,type:`button`,"aria-pressed":e.id===B(i).id,onClick:t=>d(e.id)},[G(`span`,sd,[ra($u,{formula:e},null,8,[`formula`]),G(`span`,cd,N(String(n+1).padStart(2,`0`)),1),e.id===B(i).id?(U(),W(`span`,ld,[...t[6]||=[G(`i`,null,null,-1),sa(` Открыт `,-1)]])):la(``,!0)]),G(`span`,ud,[G(`span`,dd,N(p(e)),1),G(`strong`,null,N(e.label),1),G(`span`,fd,N(e.description),1)])],10,od))),128))],8,ad),l.value.length===0?(U(),W(`div`,pd,[...t[7]||=[G(`span`,null,`∅`,-1),sa(` По такому запросу формул пока нет `,-1)]])):la(``,!0)])],544)]))}}),[[`__scopeId`,`data-v-dcbb9e62`]]),hd={class:`controls`,"aria-label":`Настройки фрактала`},gd={class:`controls-heading`},_d={class:`heading-actions`},vd={class:`panel-actions`},yd=[`disabled`],bd={key:0,"aria-hidden":`true`},xd={class:`control-stack`},Sd={class:`field formula-picker-field`},Cd={class:`formula-description`},wd={key:0,id:`formula-parameters`,class:`formula-parameters`},Td={key:0,class:`complex-pair`},Ed={class:`number-input`},Dd=[`step`,`value`,`onInput`],Od={class:`number-input`},kd=[`step`,`value`,`onInput`],Ad={key:1,class:`number-input`},jd=[`step`,`min`,`max`,`value`,`onInput`],Md={class:`field`},Nd={class:`select-wrap`},Pd={key:0,class:`field range-field`},Fd={for:`recursion-depth`},Id=[`max`],Ld={class:`field`},Rd={class:`select-wrap`},zd={key:2,class:`field range-field`},Bd={for:`iterations`},Vd=[`min`,`max`,`step`],Hd={class:`field`},Ud={class:`select-wrap`},Wd={key:3,class:`toggle-field`},Gd={key:4,class:`field range-field`},Kd={for:`color-density`},qd=Qu(ir({__name:`ControlPanel`,props:{exporting:{type:Boolean}},emits:[`exportPng`,`hide`],setup(e,{emit:t}){let n=t,r=Ll(),{activeFormula:i,colorDensity:a,geometricColoring:o,maxIterations:s,palette:c,parameterValues:l,recursionDepth:u,recursionDepthMode:d,smoothColors:f}=Cs(r),p=Ia(()=>i.value.renderer===`geometric-ifs`),m=Ia(()=>i.value.renderer===`geometric-ifs`?i.value.geometricIfs.recommendedMaxDepth:32),h=z(!1);yr(()=>{window.addEventListener(`keydown`,g)}),Sr(()=>{window.removeEventListener(`keydown`,g)});function g(e){let t=/Mac|iPhone|iPad|iPod/.test(navigator.platform)?e.metaKey:e.ctrlKey;e.key.toLocaleLowerCase()!==`k`||!t||e.altKey||e.shiftKey||(e.preventDefault(),h.value=!0)}function _(e){return e.target.value}function v(e){let t=_(e);if(t.trim()===``)return;let n=Number(t);return Number.isFinite(n)?n:void 0}function y(e){let t=l.value[e];return typeof t==`number`?t:0}function b(e,t){let n=l.value[e];return Array.isArray(n)?n[t]:0}function x(e,t){let n=v(t);n!==void 0&&r.setParameter(e,n)}function S(e,t,n){let i=v(n),a=l.value[e];if(i===void 0||!Array.isArray(a))return;let o=[a[0],a[1]];o[t]=i,r.setParameter(e,o)}return(t,l)=>(U(),W(`aside`,hd,[G(`div`,gd,[l[14]||=G(`div`,null,[G(`span`,{class:`eyebrow`},`Исследование`),G(`h1`,null,`Параметры`)],-1),G(`div`,_d,[G(`button`,{class:`icon-button`,type:`button`,"aria-label":`Сбросить вид`,title:`Сбросить вид`,onClick:l[0]||=(...e)=>B(r).resetCamera&&B(r).resetCamera(...e)},[...l[12]||=[G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`M4.9 6.8A8.5 8.5 0 1 1 3.6 15M4 4v4h4`})],-1)]]),G(`button`,{class:`icon-button`,type:`button`,"aria-label":`Скрыть панель параметров`,title:`Скрыть панель`,onClick:l[1]||=e=>n(`hide`)},[...l[13]||=[G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`M8 5 3 12l5 7M3.5 12H21`})],-1)]])])]),G(`div`,vd,[G(`button`,{class:`export-button`,type:`button`,disabled:e.exporting,onClick:l[2]||=e=>n(`exportPng`)},[l[16]||=G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`M12 3v12m-4-4 4 4 4-4M4 15v4a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-4`})],-1),G(`span`,null,[G(`strong`,null,N(e.exporting?`Готовим PNG…`:`Сохранить PNG`),1),l[15]||=G(`small`,null,`Чистый рендер · разрешение 2×`,-1)]),e.exporting?(U(),W(`i`,bd)):la(``,!0)],8,yd)]),G(`div`,xd,[G(`div`,Sd,[l[18]||=G(`span`,null,`Формула`,-1),G(`button`,{class:`formula-picker-button`,type:`button`,"aria-label":`Открыть выбор формулы`,onClick:l[3]||=e=>h.value=!0},[G(`span`,null,N(B(i).label),1),l[17]||=G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`m8 10 4 4 4-4`})],-1)])]),G(`p`,Cd,N(B(i).description),1),B(i).parameters.length>0?(U(),W(`div`,wd,[l[21]||=G(`div`,{class:`section-rule`},null,-1),(U(!0),W(Hi,null,kr(B(i).parameters,e=>(U(),W(`label`,{key:e.key,class:`field`},[G(`span`,null,N(e.label),1),e.type===`complex`?(U(),W(`span`,Td,[G(`span`,Ed,[l[19]||=G(`span`,null,`Re`,-1),G(`input`,{type:`number`,step:e.step,value:b(e.key,0),onInput:t=>S(e.key,0,t)},null,40,Dd)]),G(`span`,Od,[l[20]||=G(`span`,null,`Im`,-1),G(`input`,{type:`number`,step:e.step,value:b(e.key,1),onInput:t=>S(e.key,1,t)},null,40,kd)])])):(U(),W(`span`,Ad,[G(`input`,{type:`number`,step:e.step,min:e.min,max:e.max,value:y(e.key),onInput:t=>x(e.key,t)},null,40,jd)]))]))),128))])):la(``,!0),l[31]||=G(`div`,{class:`section-rule`},null,-1),p.value?(U(),W(Hi,{key:1},[G(`label`,Md,[l[23]||=G(`span`,null,`Глубина рекурсии`,-1),G(`span`,Nd,[jn(G(`select`,{"onUpdate:modelValue":l[4]||=e=>R(d)?d.value=e:null},[...l[22]||=[G(`option`,{value:`auto`},`Auto · по масштабу`,-1),G(`option`,{value:`manual`},`Manual · фиксированная`,-1)]],512),[[Mo,B(d)]])])]),B(d)===`manual`?(U(),W(`label`,Pd,[G(`span`,null,[l[24]||=G(`span`,null,`Количество уровней`,-1),G(`output`,Fd,N(B(u)),1)]),jn(G(`input`,{id:`recursion-depth`,"onUpdate:modelValue":l[5]||=e=>R(u)?u.value=e:null,type:`range`,min:`1`,max:m.value,step:`1`},null,8,Id),[[ko,B(u),void 0,{number:!0}]])])):la(``,!0),G(`label`,Ld,[l[26]||=G(`span`,null,`Окрашивание`,-1),G(`span`,Rd,[jn(G(`select`,{"onUpdate:modelValue":l[6]||=e=>R(o)?o.value=e:null},[...l[25]||=[G(`option`,{value:`solid`},`Однотонное`,-1),G(`option`,{value:`level`},`По уровню`,-1),G(`option`,{value:`gradient`},`Градиент`,-1)]],512),[[Mo,B(o)]])])])],64)):B(i).iterationControl?(U(),W(`label`,zd,[G(`span`,null,[G(`span`,null,N(B(i).iterationControl.label),1),G(`output`,Bd,N(B(s)),1)]),jn(G(`input`,{id:`iterations`,"onUpdate:modelValue":l[7]||=e=>R(s)?s.value=e:null,type:`range`,min:B(i).iterationControl.min,max:B(i).iterationControl.max,step:B(i).iterationControl.step},null,8,Vd),[[ko,B(s),void 0,{number:!0}]])])):la(``,!0),G(`label`,Hd,[l[28]||=G(`span`,null,`Палитра`,-1),G(`span`,Ud,[jn(G(`select`,{"onUpdate:modelValue":l[8]||=e=>R(c)?c.value=e:null},[...l[27]||=[G(`option`,{value:0},`Ultraviolet`,-1),G(`option`,{value:1},`Electric tide`,-1),G(`option`,{value:2},`Solar flare`,-1),G(`option`,{value:3},`Arctic dusk`,-1)]],512),[[Mo,B(c),void 0,{number:!0}]])])]),B(i).renderer===`escape-time`||B(i).renderer===`root-basin`?(U(),W(`label`,Wd,[l[29]||=G(`span`,null,[G(`span`,null,`Сглаживание`),G(`small`,null,`Плавные переходы между итерациями`)],-1),jn(G(`input`,{"onUpdate:modelValue":l[9]||=e=>R(f)?f.value=e:null,type:`checkbox`,role:`switch`,"aria-label":`Сглаживать цвета`},null,512),[[Ao,B(f)]])])):la(``,!0),B(i).renderer===`escape-time`||B(i).renderer===`root-basin`?(U(),W(`label`,Gd,[G(`span`,null,[l[30]||=G(`span`,null,`Плотность цвета`,-1),G(`output`,Kd,N(B(a).toFixed(3)),1)]),jn(G(`input`,{id:`color-density`,"onUpdate:modelValue":l[10]||=e=>R(a)?a.value=e:null,type:`range`,min:`0.015`,max:`0.2`,step:`0.005`},null,512),[[ko,B(a),void 0,{number:!0}]])])):la(``,!0)]),l[32]||=ca(`<footer class="controls-footer" data-v-9fc0d00e><span class="gpu-status" data-v-9fc0d00e><i aria-hidden="true" data-v-9fc0d00e></i> WebGL2</span><a href="https://github.com/KostarSf/fractal-lab" target="_blank" rel="noreferrer" aria-label="Открыть проект Fractal Lab на GitHub" data-v-9fc0d00e> GitHub · KostarSf/fractal-lab <svg viewBox="0 0 24 24" aria-hidden="true" data-v-9fc0d00e><path d="m9 15 6-6m-4 0h4v4" data-v-9fc0d00e></path></svg></a></footer>`,1),h.value?(U(),Qi(md,{key:0,onClose:l[11]||=e=>h.value=!1})):la(``,!0)]))}}),[[`__scopeId`,`data-v-9fc0d00e`]]),Jd={class:`coordinate-fields`},Yd={class:`zoom-field`},Xd={class:`zoom-input`},Zd={key:0,class:`coordinate-error`,role:`alert`},Qd={class:`coordinate-line`},$d=Qu(ir({__name:`CoordinatesDialog`,emits:[`close`],setup(e,{emit:t}){let n=t,r=Ll(),{activeFormula:i,exactCenter:a,exactScale:o}=Cs(r),s=z(),c=z(),l=z(a.value[0]),u=z(a.value[1]),d=z(wl(i.value.initialView.scale,o.value)),f=z(``),p=z(!1),m=Ia(()=>`${l.value.trim()}, ${u.value.trim()}, ${d.value.trim()}`);yr(async()=>{await vn(),s.value?.showModal(),c.value?.focus(),c.value?.select()});function h(){if(s.value?.open){s.value.close();return}n(`close`)}function g(e){e.target===s.value&&h()}function _(){f.value=``;try{let e=Cl([l.value.trim(),u.value.trim()],d.value.trim(),i.value.initialView.scale);r.setExactCamera(e),h()}catch(e){f.value=e instanceof Error?e.message:`Проверьте формат координат и масштаба.`}}async function v(){f.value=``;try{navigator.clipboard?.writeText?await navigator.clipboard.writeText(m.value):y(m.value),p.value=!0,window.setTimeout(()=>{p.value=!1},1600)}catch{try{y(m.value),p.value=!0}catch{f.value=`Не удалось скопировать строку. Выделите значения вручную.`}}}function y(e){let t=document.createElement(`textarea`);t.value=e,t.style.position=`fixed`,t.style.opacity=`0`,document.body.append(t),t.select();let n=document.execCommand(`copy`);if(t.remove(),!n)throw Error(`Clipboard API недоступен.`)}return(e,t)=>(U(),Qi($n,{to:`body`},[G(`dialog`,{ref_key:`dialog`,ref:s,class:`coordinates-dialog`,"aria-labelledby":`coordinates-title`,onCancel:Ro(h,[`prevent`]),onClick:g,onClose:t[3]||=e=>n(`close`)},[G(`form`,{class:`coordinates-shell`,onSubmit:Ro(_,[`prevent`])},[G(`header`,{class:`coordinates-header`},[t[5]||=G(`div`,null,[G(`span`,{class:`dialog-eyebrow`},`Точный переход`),G(`h2`,{id:`coordinates-title`},`Координаты и масштаб`),G(`p`,null,`Введите центр комплексной плоскости и увеличение относительно исходного вида.`)],-1),G(`button`,{class:`dialog-close`,type:`button`,"aria-label":`Закрыть`,onClick:h},[...t[4]||=[G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`m6.5 6.5 11 11m0-11-11 11`})],-1)]])]),G(`div`,Jd,[G(`label`,null,[t[6]||=G(`span`,null,`Действительная часть · Re`,-1),jn(G(`input`,{ref_key:`realInput`,ref:c,"onUpdate:modelValue":t[0]||=e=>l.value=e,type:`text`,inputmode:`decimal`,autocomplete:`off`,spellcheck:`false`},null,512),[[ko,l.value]])]),G(`label`,null,[t[7]||=G(`span`,null,`Мнимая часть · Im`,-1),jn(G(`input`,{"onUpdate:modelValue":t[1]||=e=>u.value=e,type:`text`,inputmode:`decimal`,autocomplete:`off`,spellcheck:`false`},null,512),[[ko,u.value]])]),G(`label`,Yd,[t[9]||=G(`span`,null,`Увеличение · Zoom`,-1),G(`span`,Xd,[jn(G(`input`,{"onUpdate:modelValue":t[2]||=e=>d.value=e,type:`text`,inputmode:`decimal`,autocomplete:`off`,spellcheck:`false`},null,512),[[ko,d.value]]),t[8]||=G(`i`,null,`×`,-1)])])]),f.value?(U(),W(`p`,Zd,N(f.value),1)):la(``,!0),G(`div`,Qd,[G(`code`,null,N(m.value),1),G(`button`,{type:`button`,onClick:v},[t[10]||=G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`rect`,{x:`8`,y:`8`,width:`10`,height:`10`,rx:`2`}),G(`path`,{d:`M16 8V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2`})],-1),sa(` `+N(p.value?`Скопировано`:`Копировать строку`),1)])]),G(`footer`,{class:`coordinate-actions`},[G(`button`,{class:`secondary-action`,type:`button`,onClick:h},`Отмена`),t[11]||=G(`button`,{class:`primary-action`,type:`submit`},`Перейти к виду`,-1)])],32)],544)]))}}),[[`__scopeId`,`data-v-26f8ad4d`]]),ef=class extends Error{constructor(){super(`Расчёт опорной орбиты отменён.`),this.name=`ReferenceOrbitCancelledError`}},tf=class{#e;#t;#n=0;request(e){this.cancel();let t=++this.#n,n=new Worker(new URL(`/fractal-lab/assets/reference-orbit.worker-2pRE0q2_.js`,``+import.meta.url),{type:`module`});return this.#e=n,new Promise((r,i)=>{this.#t=i,n.onmessage=e=>{let n=e.data;if(n.type===`error`&&n.requestId===t){this.#r(),i(Error(n.message));return}n.type===`result`&&n.result.requestId===t&&(this.#r(),r(n.result))},n.onerror=e=>{this.#r(),i(Error(e.message||`Ошибка deep-zoom worker.`))},n.postMessage({...e,requestId:t})})}cancel(){if(!this.#e)return;this.#e.terminate(),this.#e=void 0;let e=this.#t;this.#t=void 0,e?.(new ef)}#r(){this.#e?.terminate(),this.#e=void 0,this.#t=void 0}},nf=new Set([`mandelbrot-perturbation`,`julia-perturbation`,`tricorn-perturbation`,`burning-ship-perturbation`,`phoenix-perturbation`,`newton-cubic-perturbation`,`nova-cubic-perturbation`]);function rf(e){return e!==void 0&&nf.has(e)}var af=2048;function of(e){return e===`newton-cubic-perturbation`?`uniform float u_convergenceTolerance;`:`
