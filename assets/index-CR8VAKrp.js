...
`;function zl(e){return e.parameters.map(e=>`uniform ${e.type===`complex`?`vec2`:`float`} ${e.uniform};`).join(`
...
`}var Vl=[`u_resolution`,`u_center`,`u_scale`,`u_maxIterations`,`u_palette`,`u_colorDensity`,`u_colorOffset`,`u_smoothColors`];function Hl(e,t,n){let r=e.createShader(t);if(!r)throw Error(`WebGL не смог создать шейдер.`);if(e.shaderSource(r,n),e.compileShader(r),!e.getShaderParameter(r,e.COMPILE_STATUS)){let t=e.getShaderInfoLog(r)??`Неизвестная ошибка компиляции.`;throw e.deleteShader(r),Error(`Ошибка компиляции GLSL:\n${t}`)}return r}function Ul(e,t,n){let r=Hl(e,e.VERTEX_SHADER,t),i=Hl(e,e.FRAGMENT_SHADER,n),a=e.createProgram();if(!a)throw e.deleteShader(r),e.deleteShader(i),Error(`WebGL не смог создать программу.`);if(e.attachShader(a,r),e.attachShader(a,i),e.linkProgram(a),e.deleteShader(r),e.deleteShader(i),!e.getProgramParameter(a,e.LINK_STATUS)){let t=e.getProgramInfoLog(a)??`Неизвестная ошибка линковки.`;throw e.deleteProgram(a),Error(`Ошибка линковки WebGL-программы:\n${t}`)}return a}function Wl(e,t,n){let r=e.getUniformLocation(t,n);if(r===null)throw Error(`Uniform ${n} отсутствует в шейдере.`);return r}var Gl=class{#e;#t;#n;#r;#i;#a=new Map;#o=new Map;constructor(e){let t=e.getContext(`webgl2`,{alpha:!1,antialias:!1,depth:!1,powerPreference:`high-performance`,preserveDrawingBuffer:!1,stencil:!1});if(!t)throw Error(`WebGL2 недоступен. Проверьте поддержку браузера и аппаратное ускорение.`);let n=t.createVertexArray();if(!n)throw Error(`WebGL не смог создать vertex array.`);this.#e=e,this.#t=t,this.#n=n,t.bindVertexArray(n)}setFormula(e){let t=Ul(this.#t,Rl,Bl(e)),n=new Map,r=new Map;for(let e of Vl)n.set(e,Wl(this.#t,t,e));for(let n of e.parameters)r.set(n.key,Wl(this.#t,t,n.uniform));this.#i&&this.#t.deleteProgram(this.#i),this.#r=e,this.#i=t,this.#a=n,this.#o=r}resize(e){let t=Math.min(window.devicePixelRatio||1,2)*e,n=Math.max(1,Math.round(this.#e.clientWidth*t)),r=Math.max(1,Math.round(this.#e.clientHeight*t));return this.#e.width===n&&this.#e.height===r?!1:(this.#e.width=n,this.#e.height=r,!0)}render(e){if(!this.#i||!this.#r)throw Error(`Формула не выбрана.`);let t=this.#t;t.disable(t.BLEND),t.viewport(0,0,this.#e.width,this.#e.height),t.useProgram(this.#i),t.bindVertexArray(this.#n),t.uniform2f(this.#a.get(`u_resolution`),this.#e.width,this.#e.height),t.uniform2f(this.#a.get(`u_center`),e.center[0],e.center[1]),t.uniform1f(this.#a.get(`u_scale`),e.scale),t.uniform1i(this.#a.get(`u_maxIterations`),e.maxIterations),t.uniform1i(this.#a.get(`u_palette`),e.palette),t.uniform1f(this.#a.get(`u_colorDensity`),e.colorDensity),t.uniform1f(this.#a.get(`u_colorOffset`),e.colorOffset),t.uniform1i(this.#a.get(`u_smoothColors`),+!!e.smoothColors);for(let n of this.#r.parameters){let r=this.#o.get(n.key),i=e.parameters[n.key];!r||i===void 0||(n.type===`complex`&&Array.isArray(i)?t.uniform2f(r,i[0],i[1]):n.type===`number`&&typeof i==`number`&&t.uniform1f(r,i))}t.drawArrays(t.TRIANGLES,0,3)}dispose(){this.#i&&=(this.#t.deleteProgram(this.#i),void 0),this.#t.deleteVertexArray(this.#n)}},Kl=2048;function ql(e){return e.parameters.map(e=>`uniform ${e.type===`complex`?`vec2`:`float`} ${e.uniform};`).join(`
`)}function Jl(e){return e.basinBackend===`newton-cubic`?`
  vec2 z = point;
  int resultKind = 0;
  int rootIndex = 0;
  int iteration = 0;
...
`}function Yl(e){return e.basinBackend===`newton-cubic`?`
...
`}var Zl=[`u_resolution`,`u_center`,`u_scale`,`u_maxIterations`,`u_palette`,`u_colorDensity`,`u_colorOffset`,`u_smoothColors`],Ql=class{#e;#t;#n;#r;#i;#a=new Map;#o=new Map;constructor(e){let t=e.getContext(`webgl2`);if(!t)throw Error(`WebGL2 недоступен для root-basin renderer.`);let n=t.createVertexArray();if(!n)throw Error(`WebGL не смог создать root-basin vertex array.`);this.#e=e,this.#t=t,this.#n=n}setFormula(e){let t=Ul(this.#t,Rl,Xl(e)),n=new Map,r=new Map;for(let e of Zl)n.set(e,Wl(this.#t,t,e));for(let n of e.parameters)r.set(n.key,Wl(this.#t,t,n.uniform));this.#i&&this.#t.deleteProgram(this.#i),this.#r=e,this.#i=t,this.#a=n,this.#o=r}resize(e){let t=Math.min(window.devicePixelRatio||1,2)*e,n=Math.max(1,Math.round(this.#e.clientWidth*t)),r=Math.max(1,Math.round(this.#e.clientHeight*t));return this.#e.width===n&&this.#e.height===r?!1:(this.#e.width=n,this.#e.height=r,!0)}render(e){if(!this.#r||!this.#i)throw Error(`Root-basin формула не выбрана.`);let t=this.#t;t.disable(t.BLEND),t.viewport(0,0,this.#e.width,this.#e.height),t.useProgram(this.#i),t.bindVertexArray(this.#n),t.uniform2f(this.#a.get(`u_resolution`),this.#e.width,this.#e.height),t.uniform2f(this.#a.get(`u_center`),e.center[0],e.center[1]),t.uniform1f(this.#a.get(`u_scale`),e.scale),t.uniform1i(this.#a.get(`u_maxIterations`),e.maxIterations),t.uniform1i(this.#a.get(`u_palette`),e.palette),t.uniform1f(this.#a.get(`u_colorDensity`),e.colorDensity),t.uniform1f(this.#a.get(`u_colorOffset`),e.colorOffset),t.uniform1i(this.#a.get(`u_smoothColors`),+!!e.smoothColors),this.#s(e.parameters),t.drawArrays(t.TRIANGLES,0,3)}dispose(){this.#i&&=(this.#t.deleteProgram(this.#i),void 0),this.#t.deleteVertexArray(this.#n)}#s(e){for(let t of this.#r.parameters){let n=this.#o.get(t.key),r=e[t.key];!n||r===void 0||(t.type===`complex`&&Array.isArray(r)?this.#t.uniform2f(n,r[0],r[1]):t.type===`number`&&typeof r==`number`&&this.#t.uniform1f(n,r))}}},$l=`#version 300 es
precision highp float;
...
`,tu=[`u_resolution`,`u_center`,`u_scale`,`u_pointSize`,`u_pointCount`,`u_palette`,`u_colorOffset`,`u_exposure`],nu=class{#e;#t;#n;#r;#i;#a=new Map;#o;#s=0;constructor(e){let t=e.getContext(`webgl2`);if(!t)throw Error(`WebGL2 недоступен для Clifford renderer.`);let n=t.createVertexArray(),r=t.createBuffer();if(!n||!r)throw Error(`WebGL не смог создать ресурсы Clifford renderer.`);this.#e=e,this.#t=t,this.#n=Ul(t,$l,eu),this.#r=n,this.#i=r,t.bindVertexArray(n),t.bindBuffer(t.ARRAY_BUFFER,r),t.enableVertexAttribArray(0),t.vertexAttribPointer(0,2,t.FLOAT,!1,0,0);for(let e of tu)this.#a.set(e,Wl(t,this.#n,e));let i=t.getParameter(t.ALIASED_POINT_SIZE_RANGE);this.#o=i[1]??1}setPoints(e){let t=this.#t;t.bindBuffer(t.ARRAY_BUFFER,this.#i),t.bufferData(t.ARRAY_BUFFER,e,t.STATIC_DRAW),this.#s=Math.trunc(e.length/2)}clearPoints(){this.#s=0}resize(e){let t=Math.min(window.devicePixelRatio||1,2)*e,n=Math.max(1,Math.round(this.#e.clientWidth*t)),r=Math.max(1,Math.round(this.#e.clientHeight*t));return this.#e.width===n&&this.#e.height===r?!1:(this.#e.width=n,this.#e.height=r,!0)}render(e){let t=this.#t;if(t.viewport(0,0,this.#e.width,this.#e.height),t.clearColor(.004,.006,.012,1),t.clear(t.COLOR_BUFFER_BIT),this.#s===0)return;let n=this.#e.clientWidth>0?this.#e.width/this.#e.clientWidth:1,r=Math.min(this.#o,Math.max(1,e.pointSize*n)),i=Math.max(1,Math.min(this.#s,Math.trunc(this.#s*Math.max(.05,Math.min(1,e.pointFraction)))));t.useProgram(this.#n),t.bindVertexArray(this.#r),t.enable(t.BLEND),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.SRC_ALPHA,t.ONE),t.uniform2f(this.#a.get(`u_resolution`),this.#e.width,this.#e.height),t.uniform2f(this.#a.get(`u_center`),e.center[0],e.center[1]),t.uniform1f(this.#a.get(`u_scale`),e.scale),t.uniform1f(this.#a.get(`u_pointSize`),r),t.uniform1i(this.#a.get(`u_pointCount`),i),t.uniform1i(this.#a.get(`u_palette`),e.palette),t.uniform1f(this.#a.get(`u_colorOffset`),e.colorOffset),t.uniform1f(this.#a.get(`u_exposure`),Math.max(0,e.exposure)),t.drawArrays(t.POINTS,0,i),t.disable(t.BLEND)}dispose(){this.#t.deleteBuffer(this.#i),this.#t.deleteVertexArray(this.#r),this.#t.deleteProgram(this.#n)}};function ru(e){if(!Number.isFinite(e.contractionRatio)||e.contractionRatio<=0||e.contractionRatio>=1)throw Error(`Коэффициент сокращения IFS должен быть между 0 и 1.`);if(!Number.isInteger(e.recommendedMaxDepth)||e.recommendedMaxDepth<1||e.recommendedMaxDepth>32)throw Error(`Глубина IFS должна быть от 1 до 32.`);if(!Number.isInteger(e.defaultDepth)||e.defaultDepth<1||e.defaultDepth>e.recommendedMaxDepth)throw Error(`Начальная глубина IFS выходит за рекомендуемый предел.`);if(e.transforms.length===0||e.transforms.some(e=>!su(e)))throw Error(`IFS должен содержать конечные аффинные преобразования.`);if(e.backend===`grid`){let{columns:t,rows:n,mask:r}=e.grid,i=t*n;if(!Number.isInteger(t)||!Number.isInteger(n)||t<2||n<2||i>16||r.length!==i)throw Error(`Grid IFS поддерживает от 2 до 16 ячеек.`);if(r.filter(Boolean).length!==e.transforms.length)throw Error(`Число grid-преобразований не совпадает с маской IFS.`);if(e.baseArea.size.length!==2||e.baseArea.size.some(e=>!Number.isFinite(e)||e<=0))throw Error(`Базовый прямоугольник IFS должен иметь положительный размер.`);return}if(Math.abs(au(e.baseArea.vertices))<2**-52)throw Error(`Базовый треугольник IFS не должен быть вырожденным.`)}function iu(e,t,n){let r=Math.max(Number.MIN_VALUE,Math.abs(e)),i=Math.max(1,t),a=(n.backend===`grid`?Math.max(n.baseArea.size[0],n.baseArea.size[1]):ou(n.baseArea.vertices))*i/r,o=Math.ceil(Math.log(Math.max(1,a/1.35))/-Math.log(n.contractionRatio));return Math.max(1,Math.min(n.recommendedMaxDepth,o))}function au(e){let[t,n,r]=e;return(n[0]-t[0])*(r[1]-t[1])-(r[0]-t[0])*(n[1]-t[1])}function ou(e){let t=e.map(e=>e[0]),n=e.map(e=>e[1]);return Math.max(Math.max(...t)-Math.min(...t),Math.max(...n)-Math.min(...n))}function su(e){return[...e.matrix,...e.translate].every(Number.isFinite)}var cu=`#version 300 es
precision highp float;
precision highp int;
...
`,lu=[`u_resolution`,`u_center`,`u_scale`,`u_ruleType`,`u_baseSize`,`u_triangleA`,`u_triangleB`,`u_triangleC`,`u_gridSize`,`u_gridMask[0]`,`u_contractionRatio`,`u_recursionDepth`,`u_autoDepth`,`u_palette`,`u_colorMode`,`u_colorOffset`],uu={solid:0,level:1,gradient:2},du=class{#e;#t;#n;#r;#i=new Map;#a;constructor(e){let t=e.getContext(`webgl2`,{alpha:!1,antialias:!1,depth:!1,powerPreference:`high-performance`,preserveDrawingBuffer:!1,stencil:!1});if(!t)throw Error(`WebGL2 недоступен для geometric IFS renderer.`);let n=t.createVertexArray();if(!n)throw Error(`WebGL не смог создать vertex array для geometric IFS.`);this.#e=e,this.#t=t,this.#n=Ul(t,Rl,cu),this.#r=n,t.bindVertexArray(n);for(let e of lu)this.#i.set(e,Wl(t,this.#n,e))}setFormula(e){ru(e.geometricIfs),this.#a=e}resize(e){let t=Math.min(window.devicePixelRatio||1,2)*e,n=Math.max(1,Math.round(this.#e.clientWidth*t)),r=Math.max(1,Math.round(this.#e.clientHeight*t));return this.#e.width===n&&this.#e.height===r?!1:(this.#e.width=n,this.#e.height=r,!0)}render(e){let t=this.#a;if(!t)throw Error(`Geometric IFS-фрактал не выбран.`);let n=this.#t,r=t.geometricIfs,i=iu(e.scale,this.#e.height,r),a=e.recursionDepthMode===`auto`?i:Math.max(1,Math.min(r.recommendedMaxDepth,Math.trunc(e.recursionDepth))),o=new Int32Array(16),s=[2,2],c=[3,3],l=[[-1,-1],[1,-1],[0,1]];if(r.backend===`grid`)s=r.baseArea.size,c=[r.grid.columns,r.grid.rows],r.grid.mask.forEach((e,t)=>{o[t]=+!!e});else{l=r.baseArea.vertices;let e=l.map(e=>e[0]),t=l.map(e=>e[1]);s=[Math.max(...e)-Math.min(...e),Math.max(...t)-Math.min(...t)]}n.disable(n.BLEND),n.viewport(0,0,this.#e.width,this.#e.height),n.useProgram(this.#n),n.bindVertexArray(this.#r),n.uniform2f(this.#i.get(`u_resolution`),this.#e.width,this.#e.height),n.uniform2f(this.#i.get(`u_center`),e.center[0],e.center[1]),n.uniform1f(this.#i.get(`u_scale`),e.scale),n.uniform1i(this.#i.get(`u_ruleType`),r.backend===`grid`?0:1),n.uniform2f(this.#i.get(`u_baseSize`),s[0],s[1]),n.uniform2f(this.#i.get(`u_triangleA`),l[0][0],l[0][1]),n.uniform2f(this.#i.get(`u_triangleB`),l[1][0],l[1][1]),n.uniform2f(this.#i.get(`u_triangleC`),l[2][0],l[2][1]),n.uniform2i(this.#i.get(`u_gridSize`),c[0],c[1]),n.uniform1iv(this.#i.get(`u_gridMask[0]`),o),n.uniform1f(this.#i.get(`u_contractionRatio`),r.contractionRatio),n.uniform1i(this.#i.get(`u_recursionDepth`),a),n.uniform1i(this.#i.get(`u_autoDepth`),+(e.recursionDepthMode===`auto`)),n.uniform1i(this.#i.get(`u_palette`),e.palette),n.uniform1i(this.#i.get(`u_colorMode`),uu[e.coloring]),n.uniform1f(this.#i.get(`u_colorOffset`),e.colorOffset),n.drawArrays(n.TRIANGLES,0,3)}dispose(){this.#t.deleteProgram(this.#n),this.#t.deleteVertexArray(this.#r)}},fu=`fractal-lab-previews-v5`,pu=`renderer-v5`,mu=480,hu=300,gu=new Map,_u=new Map,vu=Promise.resolve(),yu,bu,xu,Su,Cu,wu,Tu,Eu,Du;function Ou(e){let t=`${pu}-${e.id}`,n=gu.get(t);if(n)return Promise.resolve(n);let r=_u.get(t);if(r)return r;let i=ku(e,t).catch(e=>{throw _u.delete(t),e});return _u.set(t,i),i}async function ku(e,t){let n=await Vu(t),r=n??await Au(()=>Mu(e));n||Hu(t,r);let i=URL.createObjectURL(r);return gu.set(t,i),i}function Au(e){let t=vu.then(ju).then(e);return vu=t.then(()=>void 0,()=>void 0),t}function ju(){return new Promise(e=>{if(`requestIdleCallback`in window){window.requestIdleCallback(()=>e(),{timeout:250});return}setTimeout(e,16)})}async function Mu(e){let t={...Ns(e),...e.preview.parameters};if(e.renderer===`escape-time`){let{canvas:n,renderer:r}=Fu();return r.setFormula(e),r.render(Nu(e,t)),Bu(n)}if(e.renderer===`root-basin`){let{canvas:n,renderer:r}=Iu();return r.setFormula(e),r.render(Nu(e,t)),Bu(n)}if(e.renderer===`geometric-ifs`){let{canvas:t,renderer:n}=Pu();return n.setFormula(e),n.render({center:e.preview.view.center,scale:e.preview.view.scale,recursionDepthMode:`manual`,recursionDepth:e.preview.recursionDepth??e.geometricIfs.defaultDepth,coloring:e.preview.geometricColoring??e.geometricIfs.defaultColoring,palette:e.preview.palette??0,colorOffset:e.preview.colorOffset??0}),Bu(t)}let{canvas:n,renderer:r,client:i}=Lu(),a=await i.request({a:zu(t,`a`,-1.4),b:zu(t,`b`,1.6),c:zu(t,`c`,1),d:zu(t,`d`,.7),burnIn:zu(t,`burnIn`,100),pointCount:zu(t,`pointCount`,18e4)});return r.setPoints(a.values),r.render({center:e.preview.view.center,scale:e.preview.view.scale,palette:e.preview.palette??0,colorOffset:e.preview.colorOffset??0,exposure:zu(t,`exposure`,.11),pointSize:zu(t,`pointSize`,1.25),pointFraction:1}),Bu(n)}function Nu(e,t){return{center:e.preview.view.center,scale:e.preview.view.scale,maxIterations:e.preview.iterations??e.suggestedIterations,palette:e.preview.palette??0,colorDensity:e.preview.colorDensity??.075,colorOffset:e.preview.colorOffset??0,smoothColors:!0,parameters:t}}function Pu(){return(!Cu||!wu)&&(Cu=Ru(),wu=new du(Cu)),{canvas:Cu,renderer:wu}}function Fu(){return(!yu||!bu)&&(yu=Ru(),bu=new Gl(yu)),{canvas:yu,renderer:bu}}function Iu(){return(!xu||!Su)&&(xu=Ru(),Su=new Ql(xu)),{canvas:xu,renderer:Su}}function Lu(){return(!Tu||!Eu||!Du)&&(Tu=Ru(),Eu=new nu(Tu),Du=new Il),{canvas:Tu,renderer:Eu,client:Du}}function Ru(){let e=document.createElement(`canvas`);return e.width=mu,e.height=hu,e}function zu(e,t,n){let r=e[t];return typeof r==`number`?r:n}function Bu(e){return new Promise((t,n)=>{e.toBlob(e=>{if(e){t(e);return}n(Error(`Браузер не смог создать изображение превью.`))},`image/webp`,.9)})}async function Vu(e){if(!(typeof caches>`u`))try{return(await(await caches.open(fu)).match(Uu(e)))?.blob()}catch{return}}async function Hu(e,t){if(!(typeof caches>`u`))try{await(await caches.open(fu)).put(Uu(e),new Response(t,{headers:{"Content-Type":t.type||`image/webp`}}))}catch{}}function Uu(e){return new URL(`/__fractal-previews__/${encodeURIComponent(e)}.webp`,window.location.href).href}var Wu=[`data-status`],Gu=[`src`],Ku={key:1,class:`preview-error`},qu={key:2,class:`preview-loader`},Ju=rr({__name:`FractalPreview`,props:{formula:{}},setup(e){let t=e,n=B(),r=B(``),i=B(`idle`),a,o=!1;vr(()=>{if(!n.value||!(`IntersectionObserver`in window)){s();return}a=new IntersectionObserver(e=>{e.some(e=>e.isIntersecting)&&(a?.disconnect(),a=void 0,s())},{rootMargin:`240px`}),a.observe(n.value)}),xr(()=>{o=!0,a?.disconnect()});async function s(){if(i.value===`idle`){i.value=`loading`;try{let e=await Ou(t.formula);o||(r.value=e,i.value=`ready`)}catch{o||(i.value=`error`)}}}return(e,t)=>(U(),W(`span`,{ref_key:`root`,ref:n,class:`fractal-preview`,"data-status":i.value,"aria-hidden":`true`},[r.value?(U(),W(`img`,{key:0,src:r.value,alt:``},null,8,Gu)):i.value===`error`?(U(),W(`span`,Ku,[...t[0]||=[G(`svg`,{viewBox:`0 0 24 24`},[G(`path`,{d:`M6.5 17.5 17.5 6.5M6.5 6.5l11 11`})],-1),sa(` Превью недоступно `,-1)]])):(U(),W(`span`,qu,[...t[1]||=[G(`i`,null,null,-1),G(`i`,null,null,-1),G(`i`,null,null,-1)]]))],8,Wu))}}),Yu=(e,t)=>{let n=e.__vccOpts||e;for(let[e,r]of t)n[e]=r;return n},Xu=Yu(Ju,[[`__scopeId`,`data-v-ea460355`]]),Zu={class:`picker-shell`},Qu={class:`navigator-tools`},$u={class:`formula-search`},ed={class:`category-filters`,"aria-label":`Категория формулы`},td=[`aria-pressed`,`onClick`],nd=[`aria-label`],rd=[`data-renderer`,`aria-pressed`,`onClick`],id={class:`card-visual`},ad={class:`card-index`},od={key:0,class:`active-badge`},sd={class:`card-copy`},cd={class:`card-category`},ld={class:`card-description`},ud={key:0,class:`empty-results`},dd=Yu(rr({__name:`FormulaPickerDialog`,emits:[`close`],setup(e,{emit:t}){let n=t,r=Pl(),{activeFormula:i}=Ss(r),a=B(),o=B(),s=B(``),c=B(`all`),l=Fa(()=>{let e=s.value.trim().toLocaleLowerCase(`ru`);return Ms.filter(t=>{let n=c.value===`all`||t.renderer===c.value,r=e.length===0||`${t.label} ${t.description}`.toLocaleLowerCase(`ru`).includes(e);return n&&r})});vr(async()=>{await _n(),a.value?.showModal(),o.value?.focus()});function u(){if(a.value?.open){a.value.close();return}n(`close`)}function d(e){r.selectFormula(e),u()}function f(e){e.target===a.value&&u()}function p(e){return e.renderer===`root-basin`?`Root basin`:e.renderer===`point-attractor`?`Attractor`:e.renderer===`geometric-ifs`?`Geometric IFS`:`Escape time`}return(e,t)=>(U(),Qi(Qn,{to:`body`},[G(`dialog`,{ref_key:`dialog`,ref:a,class:`formula-picker`,"aria-labelledby":`formula-picker-title`,onCancel:Lo(u,[`prevent`]),onClick:f,onClose:t[1]||=e=>n(`close`)},[G(`section`,Zu,[G(`header`,{class:`picker-header`},[t[3]||=G(`div`,{class:`picker-heading`},[G(`h2`,{id:`formula-picker-title`},`Каталог фракталов`),G(`p`,null,`Формулы, геометрические IFS, бассейны и странные аттракторы`)],-1),G(`button`,{class:`picker-close`,type:`button`,"aria-label":`Закрыть`,onClick:u},[...t[2]||=[G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`m6.5 6.5 11 11m0-11-11 11`})],-1)]])]),G(`div`,Qu,[G(`label`,$u,[t[4]||=G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`circle`,{cx:`10.5`,cy:`10.5`,r:`5.75`}),G(`path`,{d:`m15 15 4 4`})],-1),An(G(`input`,{ref_key:`searchInput`,ref:o,"onUpdate:modelValue":t[0]||=e=>s.value=e,type:`search`,placeholder:`Название или описание…`,"aria-label":`Поиск формулы`},null,512),[[Oo,s.value]]),t[5]||=G(`kbd`,null,`Esc`,-1)]),G(`div`,ed,[(U(),W(Hi,null,Or([[`all`,`Все`],[`escape-time`,`Escape`],[`root-basin`,`Basins`],[`point-attractor`,`Attractors`],[`geometric-ifs`,`IFS`]],e=>G(`button`,{key:e[0],type:`button`,"aria-pressed":c.value===e[0],onClick:t=>c.value=e[0]},P(e[1]),9,td)),64))])]),G(`div`,{class:`formula-grid`,"aria-label":`Доступно формул: ${l.value.length}`},[(U(!0),W(Hi,null,Or(l.value,(e,n)=>(U(),W(`button`,{key:e.id,class:N([`formula-card`,{"is-active":e.id===V(i).id}]),"data-renderer":e.renderer,type:`button`,"aria-pressed":e.id===V(i).id,onClick:t=>d(e.id)},[G(`span`,id,[ra(Xu,{formula:e},null,8,[`formula`]),G(`span`,ad,P(String(n+1).padStart(2,`0`)),1),e.id===V(i).id?(U(),W(`span`,od,[...t[6]||=[G(`i`,null,null,-1),sa(` Открыт `,-1)]])):ca(``,!0)]),G(`span`,sd,[G(`span`,cd,P(p(e)),1),G(`strong`,null,P(e.label),1),G(`span`,ld,P(e.description),1)])],10,rd))),128))],8,nd),l.value.length===0?(U(),W(`div`,ud,[...t[7]||=[G(`span`,null,`∅`,-1),sa(` По такому запросу формул пока нет `,-1)]])):ca(``,!0)])],544)]))}}),[[`__scopeId`,`data-v-dcbb9e62`]]),fd={class:`controls`,"aria-label":`Настройки фрактала`},pd={class:`controls-heading`},md={class:`control-stack`},hd={class:`field formula-picker-field`},gd={class:`formula-description`},_d={key:0,id:`formula-parameters`,class:`formula-parameters`},vd={key:0,class:`complex-pair`},yd={class:`number-input`},bd=[`step`,`value`,`onInput`],xd={class:`number-input`},Sd=[`step`,`value`,`onInput`],Cd={key:1,class:`number-input`},wd=[`step`,`min`,`max`,`value`,`onInput`],Td={class:`field`},Ed={class:`select-wrap`},Dd={key:0,class:`field range-field`},Od={for:`recursion-depth`},kd=[`max`],Ad={class:`field`},jd={class:`select-wrap`},Md={key:2,class:`field range-field`},Nd={for:`iterations`},Pd=[`min`,`max`,`step`],Fd={class:`field`},Id={class:`select-wrap`},Ld={key:3,class:`toggle-field`},Rd={key:4,class:`field range-field`},zd={for:`color-density`},Bd={class:`controls-footer`},Vd=Yu(rr({__name:`ControlPanel`,setup(e){let t=Pl(),{activeFormula:n,colorDensity:r,geometricColoring:i,maxIterations:a,palette:o,parameterValues:s,recursionDepth:c,recursionDepthMode:l,smoothColors:u}=Ss(t),d=Fa(()=>n.value.renderer===`geometric-ifs`),f=Fa(()=>n.value.renderer===`geometric-ifs`?n.value.geometricIfs.recommendedMaxDepth:32),p=Fa(()=>n.value.renderer===`root-basin`?`GPU root-basin renderer`:n.value.renderer===`point-attractor`?`Worker + GPU point renderer`:n.value.renderer===`geometric-ifs`?`GPU geometric IFS renderer`:`GPU escape-time renderer`),m=B(!1);vr(()=>{window.addEventListener(`keydown`,h)}),xr(()=>{window.removeEventListener(`keydown`,h)});function h(e){let t=/Mac|iPhone|iPad|iPod/.test(navigator.platform)?e.metaKey:e.ctrlKey;e.key.toLocaleLowerCase()!==`k`||!t||e.altKey||e.shiftKey||(e.preventDefault(),m.value=!0)}function g(e){return e.target.value}function _(e){let t=g(e);if(t.trim()===``)return;let n=Number(t);return Number.isFinite(n)?n:void 0}function v(e){let t=s.value[e];return typeof t==`number`?t:0}function y(e,t){let n=s.value[e];return Array.isArray(n)?n[t]:0}function b(e,n){let r=_(n);r!==void 0&&t.setParameter(e,r)}function x(e,n,r){let i=_(r),a=s.value[e];if(i===void 0||!Array.isArray(a))return;let o=[a[0],a[1]];o[n]=i,t.setParameter(e,o)}return(e,s)=>(U(),W(`aside`,fd,[G(`div`,pd,[s[11]||=G(`div`,null,[G(`span`,{class:`eyebrow`},`Исследование`),G(`h1`,null,`Параметры`)],-1),G(`button`,{class:`icon-button`,type:`button`,"aria-label":`Сбросить вид`,title:`Сбросить вид`,onClick:s[0]||=(...e)=>V(t).resetCamera&&V(t).resetCamera(...e)},[...s[10]||=[G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`M4.9 6.8A8.5 8.5 0 1 1 3.6 15M4 4v4h4`})],-1)]])]),G(`div`,md,[G(`div`,hd,[s[13]||=G(`span`,null,`Формула`,-1),G(`button`,{class:`formula-picker-button`,type:`button`,"aria-label":`Открыть выбор формулы`,onClick:s[1]||=e=>m.value=!0},[G(`span`,null,P(V(n).label),1),s[12]||=G(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`},[G(`path`,{d:`m8 10 4 4 4-4`})],-1)])]),G(`p`,gd,P(V(n).description),1),V(n).parameters.length>0?(U(),W(`div`,_d,[s[16]||=G(`div`,{class:`section-rule`},null,-1),(U(!0),W(Hi,null,Or(V(n).parameters,e=>(U(),W(`label`,{key:e.key,class:`field`},[G(`span`,null,P(e.label),1),e.type===`complex`?(U(),W(`span`,vd,[G(`span`,yd,[s[14]||=G(`span`,null,`Re`,-1),G(`input`,{type:`number`,step:e.step,value:y(e.key,0),onInput:t=>x(e.key,0,t)},null,40,bd)]),G(`span`,xd,[s[15]||=G(`span`,null,`Im`,-1),G(`input`,{type:`number`,step:e.step,value:y(e.key,1),onInput:t=>x(e.key,1,t)},null,40,Sd)])])):(U(),W(`span`,Cd,[G(`input`,{type:`number`,step:e.step,min:e.min,max:e.max,value:v(e.key),onInput:t=>b(e.key,t)},null,40,wd)]))]))),128))])):ca(``,!0),s[26]||=G(`div`,{class:`section-rule`},null,-1),d.value?(U(),W(Hi,{key:1},[G(`label`,Td,[s[18]||=G(`span`,null,`Глубина рекурсии`,-1),G(`span`,Ed,[An(G(`select`,{"onUpdate:modelValue":s[2]||=e=>z(l)?l.value=e:null},[...s[17]||=[G(`option`,{value:`auto`},`Auto · по масштабу`,-1),G(`option`,{value:`manual`},`Manual · фиксированная`,-1)]],512),[[jo,V(l)]])])]),V(l)===`manual`?(U(),W(`label`,Dd,[G(`span`,null,[s[19]||=G(`span`,null,`Количество уровней`,-1),G(`output`,Od,P(V(c)),1)]),An(G(`input`,{id:`recursion-depth`,"onUpdate:modelValue":s[3]||=e=>z(c)?c.value=e:null,type:`range`,min:`1`,max:f.value,step:`1`},null,8,kd),[[Oo,V(c),void 0,{number:!0}]])])):ca(``,!0),G(`label`,Ad,[s[21]||=G(`span`,null,`Окрашивание`,-1),G(`span`,jd,[An(G(`select`,{"onUpdate:modelValue":s[4]||=e=>z(i)?i.value=e:null},[...s[20]||=[G(`option`,{value:`solid`},`Однотонное`,-1),G(`option`,{value:`level`},`По уровню`,-1),G(`option`,{value:`gradient`},`Градиент`,-1)]],512),[[jo,V(i)]])])])],64)):V(n).iterationControl?(U(),W(`label`,Md,[G(`span`,null,[G(`span`,null,P(V(n).iterationControl.label),1),G(`output`,Nd,P(V(a)),1)]),An(G(`input`,{id:`iterations`,"onUpdate:modelValue":s[5]||=e=>z(a)?a.value=e:null,type:`range`,min:V(n).iterationControl.min,max:V(n).iterationControl.max,step:V(n).iterationControl.step},null,8,Pd),[[Oo,V(a),void 0,{number:!0}]])])):ca(``,!0),G(`label`,Fd,[s[23]||=G(`span`,null,`Палитра`,-1),G(`span`,Id,[An(G(`select`,{"onUpdate:modelValue":s[6]||=e=>z(o)?o.value=e:null},[...s[22]||=[G(`option`,{value:0},`Ultraviolet`,-1),G(`option`,{value:1},`Electric tide`,-1),G(`option`,{value:2},`Solar flare`,-1),G(`option`,{value:3},`Arctic dusk`,-1)]],512),[[jo,V(o),void 0,{number:!0}]])])]),V(n).renderer===`escape-time`||V(n).renderer===`root-basin`?(U(),W(`label`,Ld,[s[24]||=G(`span`,null,[G(`span`,null,`Сглаживание`),G(`small`,null,`Плавные переходы между итерациями`)],-1),An(G(`input`,{"onUpdate:modelValue":s[7]||=e=>z(u)?u.value=e:null,type:`checkbox`,role:`switch`,"aria-label":`Сглаживать цвета`},null,512),[[ko,V(u)]])])):ca(``,!0),V(n).renderer===`escape-time`||V(n).renderer===`root-basin`?(U(),W(`label`,Rd,[G(`span`,null,[s[25]||=G(`span`,null,`Плотность цвета`,-1),G(`output`,zd,P(V(r).toFixed(3)),1)]),An(G(`input`,{id:`color-density`,"onUpdate:modelValue":s[8]||=e=>z(r)?r.value=e:null,type:`range`,min:`0.015`,max:`0.2`,step:`0.005`},null,512),[[Oo,V(r),void 0,{number:!0}]])])):ca(``,!0)]),G(`footer`,Bd,[s[27]||=G(`span`,{class:`gpu-status`},[G(`i`,{"aria-hidden":`true`}),sa(` WebGL2`)],-1),G(`span`,null,P(p.value),1)]),m.value?(U(),Qi(dd,{key:0,onClose:s[9]||=e=>m.value=!1})):ca(``,!0)]))}}),[[`__scopeId`,`data-v-c7a3448f`]]),Hd=class extends Error{constructor(){super(`Расчёт опорной орбиты отменён.`),this.name=`ReferenceOrbitCancelledError`}},Ud=class{#e;#t;#n=0;request(e){this.cancel();let t=++this.#n,n=new Worker(new URL(`/fractal-lab/assets/reference-orbit.worker-2pRE0q2_.js`,``+import.meta.url),{type:`module`});return this.#e=n,new Promise((r,i)=>{this.#t=i,n.onmessage=e=>{let n=e.data;if(n.type===`error`&&n.requestId===t){this.#r(),i(Error(n.message));return}n.type===`result`&&n.result.requestId===t&&(this.#r(),r(n.result))},n.onerror=e=>{this.#r(),i(Error(e.message||`Ошибка deep-zoom worker.`))},n.postMessage({...e,requestId:t})})}cancel(){if(!this.#e)return;this.#e.terminate(),this.#e=void 0;let e=this.#t;this.#t=void 0,e?.(new Hd)}#r(){this.#e?.terminate(),this.#e=void 0,this.#t=void 0}},Wd=new Set([`mandelbrot-perturbation`,`julia-perturbation`,`tricorn-perturbation`,`burning-ship-perturbation`,`phoenix-perturbation`,`newton-cubic-perturbation`,`nova-cubic-perturbation`]);function Gd(e){return e!==void 0&&Wd.has(e)}var Kd=2048;function qd(e){return e===`newton-cubic-perturbation`?`uniform float u_convergenceTolerance;`:`
uniform float u_novaRelaxation;
uniform float u_novaEscapeRadius;
uniform float u_convergenceTolerance;
`}function Jd(e){return e===`newton-cubic-perturbation`?`
...
`}function Yd(e){return e===`newton-cubic-perturbation`?`
    colorIteration += quadraticConvergencePhase(
      finalMetric,
      smoothingThreshold,
      convergenceRefinementSteps
...
`:`
    colorIteration += hasPreviousMetric
      ? thresholdCrossingPhase(previousMetric, finalMetric, smoothingThreshold)
      : 1.0;
`}function Xd(e){return`#version 300 es
precision highp float;
...
`}var Zd=2052,Qd={"mandelbrot-perturbation":{texelsPerIteration:1,uniforms:``,parameterGuard:``,initialize:`
      vec2 deltaCurrent = vec2(0.0);
...
`}ef(`mandelbrot-perturbation`);var tf=[`u_resolution`,`u_centerDelta`,`u_scale`,`u_maxIterations`,`u_palette`,`u_colorDensity`,`u_colorOffset`,`u_smoothColors`,`u_referenceOrbit`,`u_referenceCount`],nf=class{#e;#t;#n;#r;#i;#a;#o=new Map;#s=new Map;#c=0;constructor(e){let t=e.getContext(`webgl2`,{alpha:!1,antialias:!1,depth:!1,powerPreference:`high-performance`,preserveDrawingBuffer:!1,stencil:!1});if(!t)throw Error(`WebGL2 недоступен для deep zoom.`);let n=t.createVertexArray(),r=t.createTexture();if(!n||!r)throw Error(`WebGL не смог создать ресурсы deep zoom.`);this.#e=e,this.#t=t,this.#n=n,this.#r=r,this.#l(`mandelbrot-perturbation`)}setReferenceOrbit(e){let t=this.#t,n=$d(e.backend);if(e.texelsPerIteration!==n)throw Error(`Deep-zoom backend ${e.backend} ожидал ${n} texel на итерацию, получено ${e.texelsPerIteration}.`);let r=t.getParameter(t.MAX_TEXTURE_SIZE);if(e.orbitLength>r||e.texelsPerIteration>r)throw Error(`Опорная орбита (${e.orbitLength} итераций) превышает лимит GPU (${r}).`);this.#l(e.backend),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,this.#r),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MAG_FILTER,t.NEAREST),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE),t.texImage2D(t.TEXTURE_2D,0,t.RGBA32F,e.texelsPerIteration,e.orbitLength,0,t.RGBA,t.FLOAT,e.values),this.#c=e.orbitLength}resize(e){let t=Math.min(window.devicePixelRatio||1,2)*e,n=Math.max(1,Math.round(this.#e.clientWidth*t)),r=Math.max(1,Math.round(this.#e.clientHeight*t));return this.#e.width===n&&this.#e.height===r?!1:(this.#e.width=n,this.#e.height=r,!0)}render(e){if(this.#c<2)throw Error(`Опорная орбита deep zoom ещё не подготовлена.`);if(e.backend!==this.#i||!this.#a)throw Error(`Deep-zoom renderer получил состояние другого backend'а.`);let t=this.#t;t.disable(t.BLEND),t.viewport(0,0,this.#e.width,this.#e.height),t.useProgram(this.#a),t.bindVertexArray(this.#n),t.activeTexture(t.TEXTURE0),t.bindTexture(t.TEXTURE_2D,this.#r),t.uniform2f(this.#o.get(`u_resolution`),this.#e.width,this.#e.height),t.uniform2f(this.#o.get(`u_centerDelta`),e.centerDelta[0],e.centerDelta[1]),t.uniform1f(this.#o.get(`u_scale`),e.scale),t.uniform1i(this.#o.get(`u_maxIterations`),e.maxIterations),t.uniform1i(this.#o.get(`u_palette`),e.palette),t.uniform1f(this.#o.get(`u_colorDensity`),e.colorDensity),t.uniform1f(this.#o.get(`u_colorOffset`),e.colorOffset),t.uniform1i(this.#o.get(`u_smoothColors`),+!!e.smoothColors),t.uniform1i(this.#o.get(`u_referenceOrbit`),0),t.uniform1i(this.#o.get(`u_referenceCount`),this.#c),this.#u(e.parameters),t.drawArrays(t.TRIANGLES,0,3)}dispose(){this.#t.deleteTexture(this.#r),this.#t.deleteVertexArray(this.#n),this.#a&&this.#t.deleteProgram(this.#a)}#l(e){if(e===this.#i)return;let t=Ul(this.#t,Rl,ef(e)),n=new Map;for(let e of tf)n.set(e,Wl(this.#t,t,e));let r=new Map,i=e===`julia-perturbation`?[[`constant`,`u_juliaConstant`]]:e===`phoenix-perturbation`?[[`constant`,`u_phoenixConstant`],[`memory`,`u_phoenixMemory`]]:e===`newton-cubic-perturbation`?[[`tolerance`,`u_convergenceTolerance`]]:e===`nova-cubic-perturbation`?[[`relaxation`,`u_novaRelaxation`],[`escapeRadius`,`u_novaEscapeRadius`],[`tolerance`,`u_convergenceTolerance`]]:[];for(let[e,n]of i)r.set(e,Wl(this.#t,t,n));this.#a&&this.#t.deleteProgram(this.#a),this.#i=e,this.#a=t,this.#o=n,this.#s=r,this.#c=0}#u(e){for(let[t,n]of this.#s){let r=e[t];Array.isArray(r)?this.#t.uniform2f(n,r[0],r[1]):typeof r==`number`?this.#t.uniform1f(n,r):t===`constant`&&this.#i===`julia-perturbation`?this.#t.uniform2f(n,-.745,.113):t===`constant`&&this.#i===`phoenix-perturbation`?this.#t.uniform2f(n,.5667,0):t===`memory`&&this.#t.uniform1f(n,-.5)}}},rf={key:0,class:`render-error`},af=[`data-state`,`data-limit`],of=[`data-state`],sf=rr({__name:`FractalCanvas`,setup(e){let t=Pl(),n=B(),r=B(``),i=B(`idle`),a=B(0),o=B(``),s=B(`idle`),c=B(0),l=B(``),u=Fa(()=>{let e=t.activeFormula;if(Gd(e.deepZoom?.backend))return e.deepZoom.backend}),d=Fa(()=>u.value!==void 0&&_l(t.magnification)),f=Fa(()=>{let e=t.activeFormula.deepZoom?.maxMagnification;return e!==void 0&&t.magnification>=e*.999999999999}),p=Fa(()=>t.activeFormula.renderer===`point-attractor`),m=Fa(()=>{if(i.value===`preparing`)return`Подготовка опорной орбиты…`;if(i.value===`ready`){let e=t.activeFormula.deepZoom?.maxMagnification;return f.value&&e!==void 0?`Deep zoom · предел ${e.toExponential(2)}×`:`Deep zoom · ${a.value} digits`}return i.value===`error`?o.value||`Deep zoom недоступен`:`Deep zoom`}),h=Fa(()=>s.value===`preparing`?`Расчёт траектории…`:s.value===`ready`?`Clifford · ${c.value.toLocaleString(`ru-RU`)} точек`:s.value===`error`?l.value||`Аттрактор недоступен`:`Clifford attractor`),g,_,v,y,b,x,S=``,C=new Ud,w=new Il,T,ee,E,D,te,O=1,k=new Map,A=t.$subscribe(()=>de(),{detached:!0});Ln(()=>t.activeFormulaId,()=>{if(n.value)try{M(),r.value=``,de()}catch(e){ie(e)}},{flush:`sync`}),Ln([()=>t.activeFormulaId,()=>ge()],()=>ve(),{flush:`sync`}),Ln(()=>[t.maxIterations,t.colorDensity,t.parameterValues],()=>N(),{deep:!0}),Ln(()=>[t.activeFormulaId,t.exactCenter[0],t.exactCenter[1],t.exactScale,t.maxIterations,me(u.value,t.parameterValues)],()=>fe(),{flush:`sync`}),vr(()=>{j(),T=new ResizeObserver(()=>de()),T.observe(n.value),window.addEventListener(`keydown`,ue),n.value.addEventListener(`webglcontextlost`,ne),n.value.addEventListener(`webglcontextrestored`,j)}),xr(()=>{A(),T?.disconnect(),window.removeEventListener(`keydown`,ue),n.value?.removeEventListener(`webglcontextlost`,ne),n.value?.removeEventListener(`webglcontextrestored`,j),ee!==void 0&&window.cancelAnimationFrame(ee),E!==void 0&&window.clearTimeout(E),D!==void 0&&window.clearTimeout(D),te!==void 0&&window.clearTimeout(te),C.cancel(),w.cancel(),re()});function j(){if(n.value)try{re(),x=void 0,S=``,g=new Gl(n.value),_=new Ql(n.value),v=new nu(n.value),y=new du(n.value),M();try{b=new nf(n.value),o.value=``}catch(e){b=void 0,i.value=`error`,o.value=e instanceof Error?e.message:String(e)}r.value=``,fe(),ve(),de()}catch(e){re(),ie(e)}}function ne(e){e.preventDefault(),g=void 0,_=void 0,v=void 0,y=void 0,b=void 0,x=void 0,C.cancel(),w.cancel(),r.value=`Контекст WebGL потерян. Ожидаем восстановления GPU.`}function M(){let e=t.activeFormula;e.renderer===`escape-time`?g?.setFormula(e):e.renderer===`root-basin`?_?.setFormula(e):e.renderer===`geometric-ifs`&&y?.setFormula(e)}function re(){g?.dispose(),_?.dispose(),v?.dispose(),y?.dispose(),b?.dispose(),g=void 0,_=void 0,v=void 0,y=void 0,b=void 0}function ie(e){r.value=e instanceof Error?e.message:String(e)}function ae(e){e.pointerType===`mouse`&&e.button!==0||k.size>=2||(k.set(e.pointerId,[e.clientX,e.clientY]),n.value.setPointerCapture(e.pointerId),n.value.classList.add(`is-dragging`),O=.58)}function oe(e){let r=k.get(e.pointerId);if(!(!r||!n.value))if(k.size===1)t.panByPixels(e.clientX-r[0],e.clientY-r[1],n.value.clientHeight),k.set(e.pointerId,[e.clientX,e.clientY]);else{let n=be();k.set(e.pointerId,[e.clientX,e.clientY]);let r=be();n&&r&&r.distance>0&&t.transformCamera(F(n.midpoint[0],n.midpoint[1]),F(r.midpoint[0],r.midpoint[1]),n.distance/r.distance)}}function se(e){k.delete(e.pointerId)&&(n.value?.classList.toggle(`is-dragging`,k.size>0),k.size===0&&(O=1,de()))}function ce(e){e.preventDefault();let n=F(e.clientX,e.clientY),r=Math.exp(Math.max(-120,Math.min(120,e.deltaY))*.002);t.transformCamera(n,n,r),N()}function le(e){let n=F(e.clientX,e.clientY);t.transformCamera(n,n,.45),N()}function ue(e){if(!(e.target instanceof HTMLInputElement||e.target instanceof HTMLSelectElement)){if(e.key===`ArrowLeft`)t.panByNormalized([-.08,0]);else if(e.key===`ArrowRight`)t.panByNormalized([.08,0]);else if(e.key===`ArrowUp`)t.panByNormalized([0,.08]);else if(e.key===`ArrowDown`)t.panByNormalized([0,-.08]);else if(e.key===`+`||e.key===`=`)t.zoomFromCenter(.8);else if(e.key===`-`)t.zoomFromCenter(1.25);else return;e.preventDefault(),N()}}function N(){O=.68,de(),E!==void 0&&window.clearTimeout(E),E=window.setTimeout(()=>{O=1,E=void 0,de()},140)}function de(){ee===void 0&&(ee=window.requestAnimationFrame(()=>{if(ee=void 0,!(!n.value||n.value.clientWidth===0||n.value.clientHeight===0))try{let e=t.activeFormula,n=u.value,r=me(n,t.parameterValues);d.value&&n&&b&&x?.backend===n&&S===r?(b.resize(O),b.render({backend:n,centerDelta:[El(t.exactCenter[0],x.center[0],t.exactScale),El(t.exactCenter[1],x.center[1],t.exactScale)],scale:Number(t.exactScale),maxIterations:t.maxIterations,palette:t.palette,colorDensity:t.colorDensity,colorOffset:t.colorOffset,smoothColors:t.smoothColors,parameters:t.parameterValues})):e.renderer===`escape-time`&&g?(g.resize(O),g.render({center:t.center,scale:t.scale,maxIterations:t.maxIterations,palette:t.palette,colorDensity:t.colorDensity,colorOffset:t.colorOffset,smoothColors:t.smoothColors,parameters:t.parameterValues})):e.renderer===`root-basin`&&_?(_.resize(O),_.render({center:t.center,scale:t.scale,maxIterations:t.maxIterations,palette:t.palette,colorDensity:t.colorDensity,colorOffset:t.colorOffset,smoothColors:t.smoothColors,parameters:t.parameterValues})):e.renderer===`point-attractor`&&v?(v.resize(O),v.render({center:t.center,scale:t.scale,palette:t.palette,colorOffset:t.colorOffset,exposure:_e(`exposure`,.045),pointSize:_e(`pointSize`,1.25),pointFraction:O*O})):e.renderer===`geometric-ifs`&&y&&(y.resize(O),y.render({center:t.center,scale:t.scale,recursionDepthMode:t.recursionDepthMode,recursionDepth:t.recursionDepth,coloring:t.geometricColoring,palette:t.palette,colorOffset:t.colorOffset}))}catch(e){ie(e)}}))}function fe(){if(C.cancel(),D!==void 0&&(window.clearTimeout(D),D=void 0),!d.value){x=void 0,S=``,i.value=`idle`,a.value=0;return}if(!b){i.value=`error`;return}i.value=`preparing`,o.value=``,D=window.setTimeout(()=>{D=void 0,pe()},120)}async function pe(){let e=u.value;if(!e)return;let r=[t.exactCenter[0],t.exactCenter[1]],s=t.exactScale,c=t.maxIterations,l=he(t.parameterValues),f=me(e,l),p=n.value?n.value.clientWidth/Math.max(1,n.value.clientHeight):1;try{let n=await C.request({backend:e,parameters:l,center:r,scale:s,maxIterations:c,viewportAspect:p});if(!d.value||u.value!==e||me(u.value,t.parameterValues)!==f||t.exactCenter[0]!==r[0]||t.exactCenter[1]!==r[1]||t.exactScale!==s||t.maxIterations!==c)return;b?.setReferenceOrbit(n),x=n,S=f,a.value=n.precisionDigits,i.value=`ready`,de()}catch(e){if(e instanceof Hd)return;i.value=`error`,o.value=e instanceof Error?e.message:String(e)}}function me(e,t){return e?`${e}|${(e===`julia-perturbation`?[`constant`]:e===`phoenix-perturbation`?[`constant`,`memory`]:e===`nova-cubic-perturbation`?[`relaxation`]:[]).map(e=>`${e}:${JSON.stringify(t[e])}`).join(`|`)}`:``}function he(e){let t={};for(let[n,r]of Object.entries(e))t[n]=Array.isArray(r)?[r[0],r[1]]:r;return t}function ge(){let e=t.activeFormula;return e.renderer===`point-attractor`?e.parameters.filter(e=>e.affectsOrbit!==!1).map(e=>`${e.key}:${String(t.parameterValues[e.key])}`).join(`|`):``}function _e(e,n){let r=t.parameterValues[e];return typeof r==`number`&&Number.isFinite(r)?r:n}function ve(){if(w.cancel(),te!==void 0&&(window.clearTimeout(te),te=void 0),!p.value){v?.clearPoints(),s.value=`idle`,c.value=0;return}if(!v){s.value=`error`,l.value=`WebGL2 renderer аттрактора недоступен.`;return}s.value=`preparing`,l.value=``,te=window.setTimeout(()=>{te=void 0,ye()},100)}async function ye(){let e=ge(),t={a:_e(`a`,-1.4),b:_e(`b`,1.6),c:_e(`c`,1),d:_e(`d`,.7),burnIn:_e(`burnIn`,100),pointCount:_e(`pointCount`,5e5)};try{let n=await w.request(t);if(!p.value||ge()!==e)return;v?.setPoints(n.values),c.value=n.pointCount,s.value=`ready`,de()}catch(e){if(e instanceof Fl)return;s.value=`error`,l.value=e instanceof Error?e.message:String(e)}}function F(e,t){let r=n.value.getBoundingClientRect();return[(e-r.left-r.width*.5)/r.height,(r.height*.5-(t-r.top))/r.height]}function be(){let[e,t]=k.values();if(!(!e||!t))return{midpoint:[(e[0]+t[0])*.5,(e[1]+t[1])*.5],distance:Math.hypot(t[0]-e[0],t[1]-e[1])}}return(e,t)=>(U(),W(Hi,null,[G(`canvas`,{ref_key:`canvas`,ref:n,id:`fractal-canvas`,"aria-label":`Визуализация фрактала`,onPointerdown:ae,onPointermove:oe,onPointerup:se,onPointercancel:se,onWheel:ce,onDblclick:le},null,544),r.value?(U(),W(`div`,rf,[t[0]||=G(`strong`,null,`Не удалось запустить GPU-рендерер`,-1),G(`span`,null,P(r.value),1)])):ca(``,!0),d.value?(U(),W(`div`,{key:1,class:`deep-zoom-status`,"data-state":i.value,"data-limit":f.value,role:`status`},[t[1]||=G(`i`,{"aria-hidden":`true`},null,-1),G(`span`,null,P(m.value),1)],8,af)):ca(``,!0),p.value?(U(),W(`div`,{key:2,class:`deep-zoom-status attractor-status`,"data-state":s.value,role:`status`},[t[2]||=G(`i`,{"aria-hidden":`true`},null,-1),G(`span`,null,P(h.value),1)],8,of)):ca(``,!0)],64))}}),cf={class:`viewer`},lf={class:`stage`,"aria-label":`Область просмотра фрактала`},uf={class:`topbar`},df={class:`coordinates`,"aria-live":`polite`},ff={id:`zoom-readout`},pf={id:`center-readout`};Vo(rr({__name:`App`,setup(e){let{exactCenter:t,exactScale:n,magnification:r}=Ss(Pl()),i=Fa(()=>`${o(r.value)}×`),a=Fa(()=>`${Dl(t.value[0],n.value)} ${t.value[1].startsWith(`-`)?`−`:`+`} ${Dl(t.value[1].replace(`-`,``),n.value)}i`);function o(e){return e>=1e6?e.toExponential(2):e>=100?Math.round(e).toLocaleString(`ru-RU`):e>=10?e.toFixed(1):e.toFixed(2)}return(e,t)=>(U(),W(`main`,cf,[G(`section`,lf,[ra(sf),G(`header`,uf,[t[1]||=G(`div`,{class:`brand`},[G(`span`,{class:`brand-mark`,"aria-hidden":`true`}),G(`span`,null,`Fractal Lab`)],-1),G(`div`,df,[G(`span`,ff,P(i.value),1),t[0]||=G(`span`,{class:`coordinate-divider`},null,-1),G(`span`,pf,P(a.value),1)])]),t[2]||=G(`div`,{class:`gesture-hint`},[G(`span`,{class:`desktop-hint`},`Перетаскивание — перемещение`),G(`span`,{class:`desktop-hint`},`Колесо — масштаб`),G(`span`,{class:`mobile-hint`},`Один палец — перемещение · два — масштаб`)],-1)]),ra(Vd)]))}})).use(ss()).mount(`#app`);